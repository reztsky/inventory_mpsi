                                    ...
                                    <td>
                                        <div class="gap-2">
                                            ...
                                            <a href="{{ route('barang.delete', $barang->id) }}"
                                                class="btn-delete btn btn-danger btn-sm my-1 my-md-0"
...
@push('script')
    <script>
        ...
        window.addEventListener('DOMContentLoaded', event => {
            const dataTable = new simpleDatatables.DataTable('#tableBarangs');
        ...
        //             if (!confirm(
        //                     'Yakin ingin menghapus data ?, menghapus data barang akan menghapus semua transaksi terkait barang tersebut'

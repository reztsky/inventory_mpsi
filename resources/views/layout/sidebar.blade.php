                ...
                <div id="ReportMenu">
                    ...
                    <div class="collapse" id="collapseReports" aria-labelledby="headingOne"
                        ...
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ route('reportBarangMasuk.index') }}">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-chart-column"></i></div> Barang
                                Masuk
                            </a>
                            <a class="nav-link" href="{{ route('reportBarangKeluar.index') }}">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-chart-line"></i></div> Barang Keluar
                            </a>
                        </nav>
                    </div>
                </div>

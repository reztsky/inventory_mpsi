                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" name="tujuan_kirim"
                                    value="{{ old('tujuan_kirim') }}" placeholder="Tujuan Kirim">
                                @error('tujuan_kirim')
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 col-sm-5 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="spinner-border spinner-border-sm ms-1 d-none" id="loading"
                                                        role="status">
                                                        <span class="visually-hidden">Loading...</span>
                                                    </div>
                                                    <input type="text" class="form-control search" placeholder="Ketikkan Nama Barang"
                                            ...
                                            <div class="col-md-3 col-sm-5 col-12">
                                                ...
                                                <div class="mb-2 input-group">
                                                    <input type="text" class="form-control" placeholder="Sub Total"
                                                        readonly name="sub_total[]" v-model="barang.sub_total">
